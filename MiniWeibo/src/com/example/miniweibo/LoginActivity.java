...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mEmailView.setText(preference.getString("email", "")); // preference.getString(标示符,默认值<这里为空>）
		mPasswordView.setText(preference.getString("password", ""));
		
		preference = getSharedPreferences("ipaddress",
				Context.MODE_PRIVATE);

		String ipString=preference.getString("ip", ""); // preference.getString(标示符,默认值<这里为空>）
		if(ipString.equals(""))
		{
				setIP();
				ipString=preference.getString("ip", ""); // preference.getString(标示符,默认值<这里为空>）
		}
	...
	private void setIP()
	{
		...
		inputServer.setText(preference.getString("ip", "")); // preference.getString(标示符,默认值<这里为空>）

		inputServer.setSelectAllOnFocus(true);
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("IP修改").setView(inputServer)
